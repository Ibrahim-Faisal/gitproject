                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="/users/create">Create Posts</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/users">All Categories</a>
                            </li>
                            <li>
                                <a href="/users/create">Create Categories</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Media<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/users">All Media</a>
                            </li>
                            <li>
                                <a href="/users/create">Upload Media</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
